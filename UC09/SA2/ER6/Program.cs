...
switch (opcao)
{
    case "1":
        ...
        obj_PF.rendimento = 2000.00f;
        novoEnd.Logradouro = "Rua Senador";
        novoEnd.numero = 1540;
        novoEnd.complemento = "Vilas Novas";
    ...
    case "2":
        ...
        novoEndPj.Logradouro = "Rua Senador";
        novoEndPj.numero = 1547;
        novoEndPj.complemento = "Empresa Plaforte";
